    ...
    grunt.initConfig({
        ...
        watch: {
			...
			sassBootstrap: {
				...
				tasks: ['sass:serverBootstrap', 'postcss:serverBootstrap']
            },
            jsTest: {
                files: ['test/spec/{,*/|,**/}*.js'],
        ...
        wiredep: {
            ...
            sass: {
                ...
                sass: {
                    ...
                    replace: {
                        css: '@import {{<%= directory%>/filePath}}',
                        sass: '@import {{<%= directory%>/filePath}}',
                        scss: '@import {{<%= directory%>/filePath}}'
                    }
                }
            }
        },
